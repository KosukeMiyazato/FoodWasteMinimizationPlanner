        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          ...
          {showMathDetails && (
            <div className="mt-4 bg-gray-50 p-6 rounded-xl border border-gray-200">
              <div className="space-y-4">
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">Objective Function</h4>
                  <code className="text-sm bg-white p-2 rounded border block">
                    minimize: Σ(weight_i × w_i) + ε × Σ(x_r)
                  </code>
                  <p className="text-sm text-gray-600 mt-2">
                    Where weight_i = 1 + 4/max(days_left_i, 1) prioritizes urgent ingredients
                  </p>
                </div>
                ...
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">Solution Method</h4>
